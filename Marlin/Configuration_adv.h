 ...
 */
#define ASSISTED_TRAMMING //Da5corp
  ...
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first //5corp

  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu //5corp
 ...
 */
#define INPUT_SHAPING_X //Da5corp
#define INPUT_SHAPING_Y //Da5corp
#define INPUT_SHAPING_Z //Da5corp
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. //5corp
#endif
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD //Da5corp
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu //Da5corp
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_WITHOUT_HOMING //Da5corp
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement) //Da5corp
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //Da5corp

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //Da5corp
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      60  // (mm) The length of filament for a complete unload. //Da5corp
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   10  // (mm) Load length of filament, from extruder gear to nozzle. //Da5corp
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
